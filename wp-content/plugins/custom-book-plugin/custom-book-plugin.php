...
function custom_book_metabox_callback( $post ) {
    ...
    echo '<input type="number" id="book_rating" name="book_rating" value="' . esc_attr( $rating ) . '" min="1" max="10"><br>';

    echo '<label for="book_publication_year">Publication Year</label>';
    echo '<input type="text" id="book_publication_year" name="book_publication_year" value="' . esc_attr( $publication_year ) . '"><br>';

    echo '<label for="book_author">Book Author</label>'; // Book Author field
    echo '<input type="text" id="book_author" name="book_author" value="' . esc_attr( $book_author ) . '"><br>'; // Book Author field
}
